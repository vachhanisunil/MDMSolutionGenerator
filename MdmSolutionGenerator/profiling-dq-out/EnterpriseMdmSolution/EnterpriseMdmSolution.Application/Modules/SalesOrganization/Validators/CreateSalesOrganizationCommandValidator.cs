...
public sealed class CreateSalesOrganizationCommandValidator : AbstractValidator<CreateSalesOrganizationCommand>
{
    public CreateSalesOrganizationCommandValidator()
    {
