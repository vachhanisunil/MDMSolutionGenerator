...
public sealed class BulkMaterialGroupJobDto
{
    ...
    public IReadOnlyList<BulkMaterialGroupJobItemDto> Items { get; init; } = [];
}

public sealed class BulkMaterialGroupJobItemDto
{
