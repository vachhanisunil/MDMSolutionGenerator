...
public sealed class BulkUpsertCustomerHandler(
    IRepository<BulkOperationJob> jobRepository,
    IRepository<BulkOperationItem> itemRepository)
    : IRequestHandler<BulkUpsertCustomerCommand, BulkCustomerJobDto>
{
    public async Task<BulkCustomerJobDto> Handle(BulkUpsertCustomerCommand request, CancellationToken cancellationToken)
    {
