...
public sealed class RunCustomerAnalysisRequestDto
{
    public string RunType { get; init; } = "Analysis";
    public string TriggeredBy { get; init; } = "system";
}

public sealed class RunCustomerAnalysisResponseDto
{
    public Guid RunId { get; init; }
    public string Status { get; init; } = string.Empty;
}

public sealed class CustomerRunDto
{
    public Guid RunId { get; init; }
...
public sealed class CustomerProfilingSummaryDto
{
...
public sealed class CustomerProfilingDrilldownDto
{
...
public sealed class CustomerRuleSummaryDto
{
...
public sealed class CustomerRuleDrilldownDto
{
    public Guid DrilldownId { get; init; }
    public Guid RunId { get; init; }
    public Guid RuleSummaryId { get; init; }
...
public sealed class CustomerDuplicateDrilldownDto
{
