...
public sealed class BulkUnitOfMeasureJobDto
{
    ...
    public IReadOnlyList<BulkUnitOfMeasureJobItemDto> Items { get; init; } = [];
}

public sealed class BulkUnitOfMeasureJobItemDto
{
