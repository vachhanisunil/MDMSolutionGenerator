...
public sealed class BulkCreateUnitOfMeasureCommandValidator : AbstractValidator<BulkCreateUnitOfMeasureCommand>
{
    public BulkCreateUnitOfMeasureCommandValidator()
    {
