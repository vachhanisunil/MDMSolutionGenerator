...
public sealed class UpdateVendorComplianceCommandValidator : AbstractValidator<UpdateVendorComplianceCommand>
{
    public UpdateVendorComplianceCommandValidator()
    {
