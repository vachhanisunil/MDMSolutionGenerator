...
public sealed class CreateCustomerCreditProfileCommandValidator : AbstractValidator<CreateCustomerCreditProfileCommand>
{
    public CreateCustomerCreditProfileCommandValidator()
    {
