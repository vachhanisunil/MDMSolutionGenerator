...
public sealed class CreateCustomerPartnerFunctionCommandValidator : AbstractValidator<CreateCustomerPartnerFunctionCommand>
{
    public CreateCustomerPartnerFunctionCommandValidator()
    {
