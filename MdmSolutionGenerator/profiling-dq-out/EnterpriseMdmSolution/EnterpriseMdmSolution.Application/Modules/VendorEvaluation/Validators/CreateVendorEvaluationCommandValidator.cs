...
public sealed class CreateVendorEvaluationCommandValidator : AbstractValidator<CreateVendorEvaluationCommand>
{
    public CreateVendorEvaluationCommandValidator()
    {
