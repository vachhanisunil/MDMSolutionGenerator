...
public sealed class BulkCreateStorageLocationCommandValidator : AbstractValidator<BulkCreateStorageLocationCommand>
{
    public BulkCreateStorageLocationCommandValidator()
    {
