...
public sealed class UpdateVendorCertificateCommandValidator : AbstractValidator<UpdateVendorCertificateCommand>
{
    public UpdateVendorCertificateCommandValidator()
    {
