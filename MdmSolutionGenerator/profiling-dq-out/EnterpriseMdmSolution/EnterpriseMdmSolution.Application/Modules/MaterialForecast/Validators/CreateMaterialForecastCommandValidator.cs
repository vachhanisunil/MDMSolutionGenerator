...
public sealed class CreateMaterialForecastCommandValidator : AbstractValidator<CreateMaterialForecastCommand>
{
    public CreateMaterialForecastCommandValidator()
    {
