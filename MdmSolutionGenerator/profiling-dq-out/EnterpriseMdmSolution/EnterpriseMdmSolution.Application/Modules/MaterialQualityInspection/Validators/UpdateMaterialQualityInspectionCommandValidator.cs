...
public sealed class UpdateMaterialQualityInspectionCommandValidator : AbstractValidator<UpdateMaterialQualityInspectionCommand>
{
    public UpdateMaterialQualityInspectionCommandValidator()
    {
