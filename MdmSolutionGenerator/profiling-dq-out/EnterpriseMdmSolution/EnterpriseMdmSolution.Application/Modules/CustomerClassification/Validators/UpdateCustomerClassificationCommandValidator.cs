...
public sealed class UpdateCustomerClassificationCommandValidator : AbstractValidator<UpdateCustomerClassificationCommand>
{
    public UpdateCustomerClassificationCommandValidator()
    {
