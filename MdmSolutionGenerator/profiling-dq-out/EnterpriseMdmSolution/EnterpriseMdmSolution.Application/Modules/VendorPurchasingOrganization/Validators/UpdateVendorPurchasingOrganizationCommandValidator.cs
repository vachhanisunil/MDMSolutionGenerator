...
public sealed class UpdateVendorPurchasingOrganizationCommandValidator : AbstractValidator<UpdateVendorPurchasingOrganizationCommand>
{
    public UpdateVendorPurchasingOrganizationCommandValidator()
    {
