...
public sealed class BulkCreatePurchasingOrganizationCommandValidator : AbstractValidator<BulkCreatePurchasingOrganizationCommand>
{
    public BulkCreatePurchasingOrganizationCommandValidator()
    {
