...
public sealed class UpdateMaterialVendorHandler(IRepository<Entity> repository, IMapper mapper)
    : IRequestHandler<UpdateMaterialVendorCommand, MaterialVendorDto?>
{
    public async Task<MaterialVendorDto?> Handle(UpdateMaterialVendorCommand request, CancellationToken cancellationToken)
    {
