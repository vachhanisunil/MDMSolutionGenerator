...
public sealed class BulkUpsertCountryHandler(IRepository<Entity> repository, IMapper mapper)
    : IRequestHandler<BulkUpsertCountryCommand, BulkCountryOperationResultDto>
{
    public async Task<BulkCountryOperationResultDto> Handle(BulkUpsertCountryCommand request, CancellationToken cancellationToken)
    {
        ...
        return new BulkCountryOperationResultDto
        {
            ...
            Items = mapper.Map<IReadOnlyList<CountryDto>>(changedEntities)
        };
    }
}