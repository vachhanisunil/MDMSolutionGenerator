...
namespace EnterpriseMdmSolution.Application.Modules.VendorAddress.Validators;

public sealed class UpdateVendorAddressCommandValidator : AbstractValidator<UpdateVendorAddressCommand>
{
    public UpdateVendorAddressCommandValidator()
    {
        ...
        RuleFor(x => x.Input.AddressType)
            .NotEmpty()
            .MaximumLength(30)
            .Must(value => new[] { "Registered", "Remittance", "Warehouse" }.Contains(value)).WithMessage("AddressType contains an unsupported value");
