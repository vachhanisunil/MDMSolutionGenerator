...
public sealed class CreateCustomerSalesAreaCommandValidator : AbstractValidator<CreateCustomerSalesAreaCommand>
{
    public CreateCustomerSalesAreaCommandValidator()
    {
