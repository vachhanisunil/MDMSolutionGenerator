...
public sealed class BulkCreateMaterialHandler(
    IRepository<BulkOperationJob> jobRepository,
    IRepository<BulkOperationItem> itemRepository)
    : IRequestHandler<BulkCreateMaterialCommand, BulkMaterialJobDto>
{
    public async Task<BulkMaterialJobDto> Handle(BulkCreateMaterialCommand request, CancellationToken cancellationToken)
    {
