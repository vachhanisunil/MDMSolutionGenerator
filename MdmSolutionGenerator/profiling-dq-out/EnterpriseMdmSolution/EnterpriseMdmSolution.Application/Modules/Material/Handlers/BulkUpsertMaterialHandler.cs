...
public sealed class BulkUpsertMaterialHandler(
    IRepository<BulkOperationJob> jobRepository,
    IRepository<BulkOperationItem> itemRepository)
    : IRequestHandler<BulkUpsertMaterialCommand, BulkMaterialJobDto>
{
    public async Task<BulkMaterialJobDto> Handle(BulkUpsertMaterialCommand request, CancellationToken cancellationToken)
    {
