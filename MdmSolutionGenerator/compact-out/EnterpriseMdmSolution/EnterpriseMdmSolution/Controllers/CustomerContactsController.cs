...
public sealed class CustomerContactsController(GenericCrudService<CustomerContact, CustomerContactDto, CreateCustomerContactDto, UpdateCustomerContactDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<CustomerContactDto>>> Search(SearchCustomerContactDto search, CancellationToken cancellationToken)
