...
public sealed class MaterialForecastsController(GenericCrudService<MaterialForecast, MaterialForecastDto, CreateMaterialForecastDto, UpdateMaterialForecastDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<MaterialForecastDto>>> Search(SearchMaterialForecastDto search, CancellationToken cancellationToken)
