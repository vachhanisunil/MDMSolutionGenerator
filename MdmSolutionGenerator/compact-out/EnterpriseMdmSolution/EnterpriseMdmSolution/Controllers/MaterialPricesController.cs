...
public sealed class MaterialPricesController(GenericCrudService<MaterialPrice, MaterialPriceDto, CreateMaterialPriceDto, UpdateMaterialPriceDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<MaterialPriceDto>>> Search(SearchMaterialPriceDto search, CancellationToken cancellationToken)
