...
public sealed class MaterialGroupsController(GenericCrudService<MaterialGroup, MaterialGroupDto, CreateMaterialGroupDto, UpdateMaterialGroupDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<MaterialGroupDto>>> Search(SearchMaterialGroupDto search, CancellationToken cancellationToken)
