...
public sealed class VendorTaxsController(GenericCrudService<VendorTax, VendorTaxDto, CreateVendorTaxDto, UpdateVendorTaxDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<VendorTaxDto>>> Search(SearchVendorTaxDto search, CancellationToken cancellationToken)
