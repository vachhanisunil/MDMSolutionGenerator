...
public sealed class PurchasingOrganizationsController(GenericCrudService<PurchasingOrganization, PurchasingOrganizationDto, CreatePurchasingOrganizationDto, UpdatePurchasingOrganizationDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<PurchasingOrganizationDto>>> Search(SearchPurchasingOrganizationDto search, CancellationToken cancellationToken)
