...
public sealed class CustomerCreditProfilesController(GenericCrudService<CustomerCreditProfile, CustomerCreditProfileDto, CreateCustomerCreditProfileDto, UpdateCustomerCreditProfileDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<CustomerCreditProfileDto>>> Search(SearchCustomerCreditProfileDto search, CancellationToken cancellationToken)
