...
public sealed class CustomerBankAccountsController(GenericCrudService<CustomerBankAccount, CustomerBankAccountDto, CreateCustomerBankAccountDto, UpdateCustomerBankAccountDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<CustomerBankAccountDto>>> Search(SearchCustomerBankAccountDto search, CancellationToken cancellationToken)
