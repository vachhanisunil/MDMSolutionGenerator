...
public sealed class CustomerAttachmentsController(GenericCrudService<CustomerAttachment, CustomerAttachmentDto, CreateCustomerAttachmentDto, UpdateCustomerAttachmentDto, int> service) : ControllerBase
{
    [HttpGet("{id}")]
    ...
    [HttpPost("search")]
    public async Task<ActionResult<PagedResult<CustomerAttachmentDto>>> Search(SearchCustomerAttachmentDto search, CancellationToken cancellationToken)
